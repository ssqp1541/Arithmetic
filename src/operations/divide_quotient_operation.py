"""
DivideQuotientOperation 클래스
소수점 나눗셈 연산을 수행하는 Strategy 구현
"""
...
class DivideQuotientOperation(Operation):
    """소수점 나눗셈 연산 클래스"""
    
    def __init__(self):
        """DivideQuotientOperation 인스턴스 생성"""
    ...
    def execute(self, a: Union[int, float], b: Union[int, float]) -> Union[int, float]:
        ...
        """
        return self._calculator.divide_quotient(int(a), int(b))
